<section class="row">
  <div class="container-fluid" style="position: relative; padding: 0; background: #000000">
    <div style="color: <?php block_field('colore'); ?>; position: relative; height: 525px;">
      <a href="https://www.youtube.com/watch?v=<?php block_field('link'); ?>" rel="noopener" target="_blank"><img class="icona-play" src="<?php echo get_stylesheet_directory_uri()?>/img/play.svg"></a>
