<section class="container mb-5 text-center">
  ...
  <div class="row">
    ...
    <div class="col-mx-12 col-md-6 col-lg-3">
      <a href="<?php block_field('link1'); ?>"><img src="<?php block_field('foto1'); ?>" style="width: 200px; height: 200px; border-radius: 50%; margin-bottom: 20px;" />
  ...
  <!-- Inizio di una card e fine di un'altra -->
    ...
    <div class="col-mx-12 col-md-6 col-lg-3">
      <a href="<?php block_field('link2'); ?>"><img src="<?php block_field('foto2'); ?>" style="width: 200px; height: 200px; border-radius: 50%; margin-bottom: 20px;" />
  ...
  <!-- Inizio di una card e fine di un'altra -->
    ...
    <div class="col-mx-12 col-md-6 col-lg-3">
      <a href="<?php block_field('link3'); ?>"><img src="<?php block_field('foto3'); ?>" style="width: 200px; height: 200px; border-radius: 50%; margin-bottom: 20px;" />
...
<!-- Inizio di una card e fine di un'altra -->
    ...
    <div class="col-mx-12 col-md-6 col-lg-3">
      <a href="<?php block_field('link4'); ?>"><img src="<?php block_field('foto4'); ?>" style="width: 200px; height: 200px; border-radius: 50%; margin-bottom: 20px;" />
