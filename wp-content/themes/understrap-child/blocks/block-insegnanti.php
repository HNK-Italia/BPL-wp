<section class="container text-center">
  ...
  <div class="row boxinsegnanti">
    ...
    <div class="col-mx-12 col-md-6 col-lg-3 tastoinsegnanti">
      <a class="tastoinsegnanti" href="<?php block_field('link1'); ?>"><img src="<?php block_field('foto1'); ?>" class="immagineinsegnanti" />
  ...
  <!-- Inizio di una card e fine di un'altra -->
    ...
    <div class="col-mx-12 col-md-6 col-lg-3 tastoinsegnanti">
      <a class="tastoinsegnanti" href="<?php block_field('link2'); ?>"><img src="<?php block_field('foto2'); ?>" class="immagineinsegnanti" />
  ...
  <!-- Inizio di una card e fine di un'altra -->
    ...
    <div class="col-mx-12 col-md-6 col-lg-3 tastoinsegnanti">
      <a class="tastoinsegnanti" href="<?php block_field('link3'); ?>"><img src="<?php block_field('foto3'); ?>" class="immagineinsegnanti" />
...
<!-- Inizio di una card e fine di un'altra -->
    ...
    <div class="col-mx-12 col-md-6 col-lg-3 tastoinsegnanti">
      <a class="tastoinsegnanti" href="<?php block_field('link4'); ?>"><img src="<?php block_field('foto4'); ?>" class="immagineinsegnanti" />
